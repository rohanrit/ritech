...
const Metrics: FunctionComponent = () => {
  return (
    <section className="self-stretch bg-brand-surface overflow-hidden flex flex-row items-start justify-center py-[75px] pr-5 pl-[21px] box-border max-w-full text-left text-13xl text-ghostwhite font-sans sm:pt-[49px] sm:pb-[49px] sm:box-border">
      <div className="w-[953px] flex flex-col items-start justify-start gap-[70px] max-w-full md800:gap-[87px] lg:gap-[35px]">
        <div className="self-stretch flex flex-row items-start justify-center py-0 px-5">
          <h1 className="m-0 relative text-inherit tracking-[-0.01em] leading-[42px] font-semibold font-inherit sm:text-lgi sm:leading-[25px] md800:text-7xl md800:leading-[43px]">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-blue via-brand-purple to-brand-cyan">Work with RiTech</span>
          </h1>
        </div>
