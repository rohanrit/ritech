...
const ScrollView: FunctionComponent = () => {
  return (
    <div className="self-stretch flex flex-col items-end justify-start gap-[110px] max-w-full text-left text-29xl text-ghostwhite font-sans mq450:gap-[27px] mq800:gap-[55px]">
      <AboutSection
