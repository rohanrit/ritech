...
const CopyButton: FunctionComponent<CopyButtonType> = ({
  ...
  return (
    <div
      className="w-full sm:w-full flex flex-col items-center justify-center gap-8 text-left text-13xl text-ghostwhite font-sans"
    ...
    >
      <div className="self-stretch flex flex-row items-start justify-start py-0 pr-8 pl-8">
        <button className="cursor-pointer border-none p-0 bg-transparent h-24 flex-1 flex flex-row items-start justify-start relative gap-4">
          <div className="h-full w-full absolute top-0 left-0 rounded-full bg-gradient-to-br from-brand-blue/40 to-brand-purple/40 border border-brand-border" />
          <img
      ...
      <div className="self-stretch flex flex-col items-start justify-center py-0 pr-4 pl-4 md800:pr-8">
        <div className="flex flex-row items-center justify-center py-0 px-4">
          <div
            className="relative tracking-wide leading-10 font-semibold inline-block sm:text-lgi md800:text-7xl text-transparent bg-clip-text bg-gradient-to-r from-brand-cyan to-brand-glow"
            style={logicLinkStyle}
          >
            {logicLink}
          </div>
        </div>
        <div className="relative text-base leading-loose font-medium text-slate-300">
          {happyCustomers}
        </div>
      </div>
    </div>
